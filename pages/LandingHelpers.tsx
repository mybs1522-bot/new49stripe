  ...
  return (
    <div className="relative py-12 md:py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto relative z-10 text-center">
        ...
        <div className="mb-6">
          <p className="text-red-400 font-semibold text-sm mt-2">SketchUp + V-Ray + D5 Render AI — All 3 Courses</p>
        </div>
...
export const FAQ_ITEMS_LANDING = [
  { question: "What exactly do I get?", answer: "You get 3 complete courses: SketchUp Pro (3D modeling), V-Ray Photorealism (magazine-quality renders), and D5 Render AI (real-time AI rendering). Plus 10,000+ textures, 2,000+ 3D models, all software download links, a certified diploma, and 24/7 team support. Lifetime access, one-time payment. AutoCAD is available as an optional add-on at checkout." },
  { question: "I'm a complete beginner — is this for me?", answer: "Absolutely! SketchUp builds up to full 3D interiors, and V-Ray and D5 Render follow the same beginner-friendly approach. Our 24/7 support team is always a WhatsApp message away whenever you feel stuck." },
  ...
  { question: "Will this actually help me get clients or a job?", answer: "Yes. The #1 reason designers struggle to land clients is they can't produce professional photorealistic renders. This bundle teaches you the full pipeline — SketchUp to model, V-Ray for beauty shots, D5 AI for real-time presentations. Designers with these skills charge $2,000–$5,000 per project." },
